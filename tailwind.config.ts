  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        moveBackground: "moveBackground 15s ease-in-out infinite",
        moveBackground2: "moveBackground2 20s ease-in-out infinite",
        moveBackground3: "moveBackground3 25s ease-in-out infinite",
      },
    },
  },
  fontFamily: {
