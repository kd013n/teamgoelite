...
import { Description, ModalView } from "./CareersTypes";
...
export default function CareersGrid() {
  ...
  const [modalView, setModalView] = useState<ModalView>(ModalView.CareersInfo);
  ...
  const openModal = (description: Description) => {
    ...
    setModalView(ModalView.AppForm);
  };

  const closeModal = () => {
    setSelectedDescription(null);
    setModalView(ModalView.CareersInfo);
  };
  ...
  return (
    <div className="bg-white">
      {modalView === ModalView.CareersInfo && (
                      ...
                      {modalView === "productInfo" && (
                        <>
                          ...
                          <div className="mt-6 flex flex-col space-y-4">
                            ...
                            <button
                              onClick={() =>
                                setModalView(ModalView.Description)
                              }
                      ...
                      {modalView === "confirmation" && (
                        <>
                          ...
                          <p className="mt-2 text-sm text-gray-500">
                            ...
                            will be forwarded to a financial adviser for review.
                            We appreciate your time and effort.
                          </p>
                          <p className="mt-2 text-sm text-gray-500">
                            Please close this pop-up once you&apos;re done.
                            Thank you!
                          </p>
